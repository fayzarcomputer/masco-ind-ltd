  ...
  invoices: [
    {
      ...
      // Worker & Supervisor Attribution
      created_by: '11111111-1111-1111-1111-111111111111',
      creator_name: 'Md. Rafiqul Islam - Operator',
      creator_mobile: '01711000001',
      supervisor_id: '22222222-2222-2222-2222-222222222222',
      supervisor_name: 'Kamrul Hasan - Floor Supervisor',
      supervisor_mobile: '01811000002',
      approval_status: 'APPROVED',
      approved_by: '22222222-2222-2222-2222-222222222222',
      approved_by_name: 'Kamrul Hasan - Floor Supervisor',
      approval_date: '2026-09-12T11:30:00Z',
      clients: {
        applicant_name: 'MALACCA SOURCING PTE. LTD.,',
        office_address: '6 SHENTON WAY, #18-10, OUE DOWNTOWN, SINGAPORE 068809',
        country: 'SINGAPORE',
    ...
    {
      id: 'd1206000-0000-0000-0000-000000001206',
      invoice_no: 'MIL/MS/1206/2026',
      invoice_date: '2026-09-14',
      exp_no: '0216-023258-2026',
      exp_date: '2026-09-14',
      sc_no: 'MS26/5002-SS27',
      sc_date: '2026-04-10',
      client_id: '11111111-1111-1111-1111-111111111111',
      ...
      total_carton: 15,
      total_pcs: 750,
      total_gross_weight: 168.50,
      total_net_weight: 145.20,
      total_cbm: 0.765,
      total_amount: 2310.00,
      status: 'ISSUED',
      created_at: '2026-09-14T14:20:00Z',
      // Worker 2 (Anisur Rahman) under Supervisor Kamrul Hasan
      created_by: '11111111-1111-1111-1111-222222222222',
      creator_name: 'Anisur Rahman - Entry Operator',
      creator_mobile: '01711000002',
      supervisor_id: '22222222-2222-2222-2222-222222222222',
      supervisor_name: 'Kamrul Hasan - Floor Supervisor',
      supervisor_mobile: '01811000002',
      ...
      invoice_items: [
        {
          id: '1',
          order_no: 'BLSS2700058680BN',
          po_number: 'BLSS2700058680BN',
          item_ref: '152415',
          style: '152415',
          production_description: "Men's Polo Shirt",
          item_description: "Men's Polo Shirt",
          hs_code: '610510',
